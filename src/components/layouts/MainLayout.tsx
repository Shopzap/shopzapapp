...
import { Home, Package, ShoppingCart, Settings, BarChart2, Users, Menu, X, LogOut, Palette, Instagram } from 'lucide-react';
...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Customize Store', icon: Palette, path: '/dashboard/customize-store' },
    { name: 'Instagram Automation', icon: Instagram, path: '/dashboard/automation' },
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 md:flex-row">
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-md flex flex-col transform ${
