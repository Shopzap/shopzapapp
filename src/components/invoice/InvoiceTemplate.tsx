...
const InvoiceTemplate = ({ order }: InvoiceTemplateProps) => {
  ...
  return (
    <div className="relative p-8 bg-white text-black" style={{ fontFamily: 'Arial, sans-serif' }}>
      {/* ShopZap Watermark */}
      <div 
      ...
      >
        <img 
          src="/lovable-uploads/a66614ae-eff4-4811-b330-d56273f89034.png" 
          alt="ShopZap Watermark"
        ...
        <div className="border-t pt-6 text-center text-sm text-gray-600">
          <div className="flex items-center justify-center gap-2 mb-2">
            <img 
              ...
              className="w-6 h-6"
            />
            <span className="font-semibold text-gray-800">Powered by ShopZap</span>
          </div>
          ...
          <p className="mt-3 text-xs text-gray-400">
            Create your own online store at shopzap.io
          </p>
        </div>
      </div>
    </div>
