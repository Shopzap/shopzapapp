  ...
  try {
    ...
    if (!code) {
      ...
      return new Response(null, {
        ...
        headers: {
          ...corsHeaders,
          'Location': '/dashboard/instagram-automation?error=no_code'
        }
      })
    }
    ...
    const tokenResponse = await fetch('https://api.sendpulse.com/oauth/access_token', {
      ...
      body: JSON.stringify({
        ...
        code: code,
        redirect_uri: `${Deno.env.get('SUPABASE_URL')}/functions/v1/sendpulse-callback`
      })
    })
    ...
    if (!tokenResponse.ok) {
      ...
      return new Response(null, {
        ...
        headers: {
          ...corsHeaders,
          'Location': '/dashboard/instagram-automation?error=token_exchange_failed'
        }
      })
    }
    ...
    if (!pagesResponse.ok) {
      ...
      return new Response(null, {
        ...
        headers: {
          ...corsHeaders,
          'Location': '/dashboard/instagram-automation?error=account_fetch_failed'
        }
      })
    }
    ...
    if (!instagramAccount) {
      ...
      return new Response(null, {
        ...
        headers: {
          ...corsHeaders,
          'Location': '/dashboard/instagram-automation?error=no_instagram_accounts'
        }
      })
    }
    ...
    if (dbError) {
      ...
      return new Response(null, {
        ...
        headers: {
          ...corsHeaders,
          'Location': '/dashboard/instagram-automation?error=database_error'
        }
      })
    }
    ...
    return new Response(null, {
      ...
      headers: {
        ...corsHeaders,
        'Location': '/dashboard/instagram-automation?error=unexpected_error'
      }
    })
  }
})
